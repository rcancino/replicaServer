...
<section id="edit-entityConfiguration" class="first">
	...
	<g:form method="post" class="form-horizontal" >
		<g:hiddenField name="id" value="${entityConfigurationInstance?.id}" />
		<g:hiddenField name="version" value="${entityConfigurationInstance?.version}" />
		<fieldset class="form">
