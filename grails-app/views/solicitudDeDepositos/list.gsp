...
<body>
	...
	<div class="">
		<div class="row">
			<h3>${cmd.sucursal.nombre } Del: ${cmd.fechaInicial.format('dd/MM/yyyy') } al ${cmd.fechaFinal.format('dd/MM/yyyy')}  </h3>		
		</div>
		...
		<div class="row">
			<div class="span3 ">
				<ul class="nav nav-pills nav-stacked">
					<li class="active">
						<a href="#cambiarSucursalPeriodoDialog" data-toggle="modal">Cambiar</a>
					</li>
					<li class="">
						<g:link action="cancelacionDeSolicitudes">Cancleaciones</g:link>
					</li>
				</ul>
			</div>
