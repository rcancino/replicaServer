 ...
 * 
 */
class CancelacionDeSolesService {
...
//		
			...
			where t.TRASLADO_ID is null and U.nombre=?  and s.fecha>='2015/04/30' AND S.FECHA< CURRENT_DATE-1 AND S.COMENTARIO NOT LIKE 'CANC%'
		"""
